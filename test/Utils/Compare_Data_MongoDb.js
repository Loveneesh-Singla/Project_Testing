...
class MongoDB_Data{
    ...
    async check_data_for_reservations(jumperNames,isweekend,payOption){
        ...
        for(let i = 0 ;i<jumperNames.length;i++){
            ...
            SelectedTandemPackPrice = payOption !== "deposit" ? SelectedTandemPackPrice :25;
            ...
            const totalPaid = payOption === "deposit" ? 25+selectedVideoPrice : SelectedTandemPackPrice+selectedVideoPrice;
