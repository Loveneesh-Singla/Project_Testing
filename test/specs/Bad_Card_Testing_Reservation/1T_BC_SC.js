...
describe("Try to reserve one ticket and used card is stolen, checked error response in email",()=>{

    it("Try to reserve one ticket and used card is stolen, checked error response in email",async()=>{
        let card = "Stolen Card";
        let card_Number = 4000000000009979;
        let Error_Message = "Stolen Card"
        let numOfTickets = 1;
