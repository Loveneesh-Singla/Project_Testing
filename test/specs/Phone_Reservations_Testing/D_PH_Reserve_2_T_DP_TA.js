...
describe("Reserve two tickets with deposit pay on phone link, tandem package is taxble",()=>{

    it("Two tickets with deposit pay, tandem package is taxble & no weekend",async()=>{
        let numOfTickets = 2;
        let videoOptions = ["",""]
