...
describe("Reserve two tickets first selected deposit pay then No pay, tandem package is taxble",()=>{
    it("Reserve two tickets first selected deposit pay then No pay, tandem package is taxble",async()=>{
        let numOfTickets = 2;
        let videoOptions = [""]
