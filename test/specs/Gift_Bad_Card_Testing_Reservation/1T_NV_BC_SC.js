...
describe("Try to buy a gift card and used card is stolen, checked error response in email",()=>{
    it("Try to buy a gift card and used card is stolen, checked error response in email",async()=>{
