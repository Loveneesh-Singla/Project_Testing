...
describe("Try to buy a gift card and used card has  insufficient funds, checked error response in email",()=>{
    it("Try to buy a gift card and used card has insufficient funds, checked error response in email",async()=>{
