...
describe("Reserve two tickets first deposit pay then full pay, tandem package & selected video are taxble",()=>{

    it("Two tickets first deposit pay then full pay, tandem package & selected video are taxble & no weekend",async()=>{
        let numOfTickets = 2;
